...
String path = "D:/git/YZR/project/src/main/webapp/Image_upload"; // 이미지가 저장될 주소
String filename = "";
...
<%
	...
	try {
		...
		java.text.SimpleDateFormat formatter2 = new java.text.SimpleDateFormat ("yy_MM_dd_HH_MM_SS", java.util.Locale.KOREA);
		int cnt = 1;
