			...
			<div class="col-sm-6 col-md-4 col-md-offset-4" style="margin-top: 100px;">
				<c:choose>
	            	<c:when test="${ error == 'loginerror' }">
	            		<font class="text-center login-title" style="font-size:8pt; color: red;">입력하신 정보가 올바르지 않습니다. 다시 시도해 주세요.</font>
	            	</c:when>
	            	<c:otherwise>
	            		<font class="text-center login-title" style="font-size:8pt">아이디 비밀번호를 입력하신 후, 로그인 버튼을 클릭해 주세요.</font>
	            	</c:otherwise>
	            </c:choose>
